...
class FormsTestCases(unittest.TestCase):
    ...
    def test_When_withdraw__is_greater_than_new_balance_write_errormessage(self):
        customer = Customer(GivenName="Kalle", Surname="Karlsson", Streetaddress="Sveavägen", City="Norrköping", Zipcode="12345", Country="SWEDEN", CountryCode="SE", Birthday=datetime.now(), NationalId="19700413-1234", TelephoneCountryCode=46, Telephone="(000)123-7654", EmailAddress="Kalle@hotmail.se")
